 ...
 * Use the {@link ZOCameraFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class ZOCameraFragment extends ZZCameraVideoFragment {

    private static final String TAG = "ZOCameraFragment";
    private static final String VIDEO_DIRECTORY_NAME = "AndroidWave";
    @BindView(R.id.mTextureView)
    ZZAutoFitTextureView mTextureView;
    ...
    public static ZOCameraFragment newInstance() {
        ZOCameraFragment fragment = new ZOCameraFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.z_fragment_camera, container, false);
        ...
        switch (view.getId()) {
            case R.id.mRecordVideo:
                ...
                if (mIsRecordingVideo) {
                    ...
                    startRecordingVideo();
                    mRecordVideo.setImageResource(R.drawable.stop);
